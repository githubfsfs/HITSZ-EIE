...
C_HM_CONV = ConvInterleave(C_HM_RE,B,M0);
% 随机交织
...
%% 汉明码译码
    % 预处理(重排)
    Rdedi_HM_CONV_pre = Preprocess_HM_decoded(Rdedi_HM_CONV);
    Rdedi_HM_RANDOM_pre = Preprocess_HM_decoded(Rdedi_HM_RANDOM);
    Rdedi_HM_BLOCK_pre = Preprocess_HM_decoded(Rdedi_HM_BLOCK);
